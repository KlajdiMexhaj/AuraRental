      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
          ...
          <div className="lg:w-1/3 flex flex-col justify-center">
            <span className="text-[#8ecd24] text-[10px] font-black uppercase tracking-[0.4em] mb-4 block">{t("location.subtitle")}</span>
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 tracking-tighter uppercase">{t("location.title")}</h2>
            ...
            <div className="space-y-8">
              <div className="group cursor-default">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h4 className="text-white font-bold tracking-tight">{t("location.mainHubTitle")}</h4>
                </div>
              ...
              <div className="group cursor-default">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h4 className="text-white font-bold tracking-tight">{t("location.hoursTitle")}</h4>
                </div>
                <p className="text-gray-500 text-sm leading-relaxed ml-14">
                  {t("location.hours")}
                </p>
              ...
              <div className="group cursor-default">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h4 className="text-white font-bold tracking-tight">{t("location.phoneTitle")}</h4>
                </div>
