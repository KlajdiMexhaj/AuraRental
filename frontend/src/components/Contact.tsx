    ...
    <div className="group relative glass rounded-[2.5rem] overflow-hidden transition-all duration-700 hover:border-[#8ecd24]/40 hover:-translate-y-2">
      ...
      <div className="relative aspect-[16/11] overflow-hidden">
        ...
        <div className="absolute top-6 right-6">
          <div className="bg-black/60 backdrop-blur-xl px-4 py-2 rounded-2xl border border-white/10 flex items-center gap-2">
            <span className="text-[#8ecd24] font-black text-lg">
              {t("car.currency")}{car.price}
            </span>
        ...
        <div className="absolute top-6 left-6 opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
          <span className="bg-[#8ecd24] text-[#011111] px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-tighter">
            {t("car.availableNow")}
          </span>
        </div>
      </div>
      ...
      <div className="p-8 relative z-10 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          ...
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-white/[0.03] border border-white/5">
            <span className="text-gray-400 text-[11px] font-bold uppercase">
              {car.transmission || t("car.automatic")}
            </span>
          </div>
        ...
        <Link
          ...
          className="group/btn relative bg-white/5 border border-white/10 text-white py-5 rounded-[1.25rem] text-center font-bold text-sm transition-all hover:bg-[#8ecd24] hover:text-[#011111] hover:border-[#8ecd24]"
        >
          <span className="relative z-10 flex items-center justify-center gap-2">
            {t("car.viewReservation")}
