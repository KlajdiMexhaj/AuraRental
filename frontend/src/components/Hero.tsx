      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h1 className="text-6xl md:text-8xl font-bold text-white leading-[0.9] mb-8 tracking-tighter">
            {t("hero.title1")} <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8ecd24] via-white to-[#8ecd24] bg-[length:200%_auto] animate-gradient">
              {t("hero.title2")}
            </span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="group p-4 rounded-2xl bg-white/5 border border-transparent focus-within:border-[#8ecd24]/30 transition-all">
                <label className="block text-[10px] uppercase font-black text-gray-500 mb-2 tracking-widest group-focus-within:text-[#8ecd24]">
                  {t("hero.pickup")}
                </label>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-8 md:gap-12">
            {["hero.feature1", "hero.feature2", "hero.feature3"].map((key) => (
              <div
                key={key}
                className="flex items-center gap-3 opacity-60 grayscale hover:grayscale-0 transition-all cursor-default"
              >
