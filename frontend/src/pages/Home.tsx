...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Check if path ends with /about or /contact regardless of language prefix
    ...
    <div className="bg-[#011111] overflow-hidden">
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <span className="text-[#8ecd24] text-[10px] font-black tracking-[0.4em] uppercase mb-4 block animate-fade-in">
              {t("exclusive")}
            </span>
          ...
          {/* Fixed Link to include language */}
          <Link 
            to={lp("/cars-rental")} 
            className="text-[#8ecd24] font-black text-xs uppercase tracking-[0.2em] flex items-center gap-3 group"
          >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-700">{t("accessing")}</span>
          </div>
        ) : (
