    ...
    <div className="bg-[#011111] overflow-hidden">
      ...
      <section className="py-32 max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <span className="text-[#8ecd24] text-[10px] font-black tracking-[0.4em] uppercase mb-4 block animate-fade-in">{t("exclusive")}</span>
            <h2 className="text-4xl md:text-6xl font-bold text-white tracking-tighter uppercase">{t("featuredFleet")}</h2>
          </div>
